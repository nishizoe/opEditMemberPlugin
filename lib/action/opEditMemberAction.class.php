...
abstract class opEditMemberAction extends sfActions
{
...
*/
    $params = $this->request->getParameter('member', array());
// 入力されたメンバーidをログ出力中
...
//    $this->relation = Doctrine::getTable('MemberRelationship')->retrieveByFromAndTo($this->id, $this->id);
...
//      $this->relation->setMemberIdFrom($this->id);
...
*/
  ...
  {
/*
    $this->memberForm = new MemberForm($this->id);
