 ...
 * @author     
 */
class opMemberEditForm extends BaseForm
{
...
//sfContext::getInstance()->getLogger()->info('★★★★★★is_use_id::[['.$this->getOption('is_use_id').']]');
//    if ($this->getOption('is_use_id'))
//    {
        
sfContext::getInstance()->getLogger()->info('★★★ id ★★★[['.$this->getValue('id').']]');
